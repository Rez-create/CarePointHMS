    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('doctor', 'Doctor'), ('pharmacist', 'Pharmacist'), ('nurse', 'Nurse'), ('lab_technician', 'Lab Technician'), ('admin', 'Admin'), ('receptionist', 'Receptionist')], max_length=20)),
